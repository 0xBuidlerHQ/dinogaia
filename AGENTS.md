...
- **Layout**: Mirror the section separators used in `ItemsSet.sol` (`////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////` blocks) to visually group constructors, storage, events, errors, and core logic.
...
- **State updates**: Keep public state mutation minimal; prefer `internal`/`private` helpers. When overriding, call `super` as in `ItemsSet._update`.
